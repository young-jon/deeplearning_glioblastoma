...
class RBM(object):
    ...
    def get_cost_updates(self, lr=0.1, persistent=None, k=1):
        ...
        return monitoring_cost, updates, chain_end
...
def test_rbm(learning_rate=0.1, training_epochs=15,
    ...
    ###Added by jdy: Used for sampling from the learning distribution(generative
    model) for creating images. For my purposes, this value is irrelevant and 
    will not be used.
