...
def test_DBN(finetune_lr=999, pretraining_epochs=1,
    ...
    save_short(dbn, '/Users/jon/models/DBNDA_theano/model_test.pkl')
    save_med_pkl(dbn, '/Users/jon/models/DBNDA_theano/model_test2.pkl')
    save_med_npy(dbn, '/Users/jon/models/DBNDA_theano/model_test3.npy')
